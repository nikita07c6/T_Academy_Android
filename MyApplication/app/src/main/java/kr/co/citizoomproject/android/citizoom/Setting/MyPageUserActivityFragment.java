 ...
 */
public class MyPageUserActivityFragment extends Fragment {
    public static int increment;
    static MyPageActivity owner;

    public MyPageUserActivityFragment() {
    }

    public static MyPageUserActivityFragment newInstance(int initValue) {
        MyPageUserActivityFragment myPageUserActivityFragment = new MyPageUserActivityFragment();
        Bundle bundle = new Bundle();
        bundle.putInt("value", initValue);
        myPageUserActivityFragment.setArguments(bundle);
        return myPageUserActivityFragment;
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        RecyclerView rv = (RecyclerView) inflater.inflate(R.layout.my_page_user_activity_fragment, container, false);
