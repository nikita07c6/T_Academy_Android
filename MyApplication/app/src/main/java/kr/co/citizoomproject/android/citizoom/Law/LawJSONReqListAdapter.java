 ...
 */
public class LawJSONReqListAdapter extends RecyclerView.Adapter<LawJSONReqListAdapter.ViewHolder> {
    String SERVER_URL_LAWS_PROS_CONS, SERVER_URL_LAW_LIKE;
    Activity owner;
    public ArrayList<LawEntityObject> lawEntityObjects;

    public LawJSONReqListAdapter(Context context, ArrayList<LawEntityObject> resources) {
        owner = (Activity) context;

        this.lawEntityObjects = resources;
    }

    public void addItemsData(ArrayList<LawEntityObject> valueObjects) {
        lawEntityObjects.clear();
        if (valueObjects != null && valueObjects.size() > 0) {
            lawEntityObjects.addAll(valueObjects);
        }
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        Log.e("MainLawList", lawEntityObject.title);

        String whatcommittee = lawEntityObject.committee.toString();
        Log.e("whatcommittee", whatcommittee);
        int thiscommittee = getCommittee(whatcommittee);
        Log.e("thiscommittee", String.valueOf(thiscommittee));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public final FrameLayout agree_layout;
        public final FrameLayout disagree_layout;
        public final ToggleButton interest_law_mark;
        public final ToggleButton agree_Button;
        public final ToggleButton disagree_Button;
        ...
        public ViewHolder(View view) {
            ...
            agree_layout = (FrameLayout) view.findViewById(R.id.agree_layout);
            disagree_layout = (FrameLayout) view.findViewById(R.id.disagree_layout);
        }
    }
