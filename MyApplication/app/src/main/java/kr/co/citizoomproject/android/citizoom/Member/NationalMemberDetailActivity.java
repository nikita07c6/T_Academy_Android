 ...
 */
public class NationalMemberDetailActivity extends AppCompatActivity {
    ...
    protected void onDestroy() {
        super.onDestroy();
        //new NationalMemberFragment.AsyncMemberJSONList().execute();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        repID = intent.getIntExtra("repID", repID);
        Log.e("intentrepID", String.valueOf(repID));
        ...
        Log.e("SERVER_URL_REP_NEWS", SERVER_URL_REP_NEWS);
